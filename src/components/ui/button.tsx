...
const buttonClasses = cva(
  'inline-flex items-center justify-center font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed',
  {
    variants: {
      variant: {
        primary: 'bg-button-background text-button-text border border-button-border hover:bg-primary-background focus:ring-primary-light',
        secondary: 'bg-gray-200 text-gray-800 hover:bg-gray-300 focus:ring-gray-500',
        outline: 'border-2 border-primary-light text-primary-light bg-transparent hover:bg-primary-light hover:text-white focus:ring-primary-light',
